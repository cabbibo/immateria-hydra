...
public class HydraOld : MonoBehaviour {




  public Texture2D  baseNormalMap;
  public Cubemap    baseCubeMap;
  public Texture2D  tubeNormalMap;
  public Cubemap    tubeCubeMap;

  public Texture2D  seaNormalMap;
  public Cubemap    seaCubeMap;
  ...
  void OnEnable () {
    ...
    mb.normalMap = seaNormalMap;
    mb.cubeMap = seaCubeMap;
   ...
   // Center.AddComponent<AddWhiskerBox>();
    AddWhiskerBox wb = Center.AddComponent<AddWhiskerBox>();
    wb.cubeMap = baseCubeMap;
    wb.normalMap = baseNormalMap;
    ...
    ct.cubeMap   = tubeCubeMap;
    ct.normalMap = tubeNormalMap;
    ...
    for( int i = 0; i < directions.Length; i++ ){
      ...
      AddWhiskerBox wb2 = cube.AddComponent<AddWhiskerBox>();
      wb2.cubeMap = baseCubeMap;
      wb2.normalMap = baseNormalMap;
