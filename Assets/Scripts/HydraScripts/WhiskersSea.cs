...
public class WhiskersSea : MonoBehaviour
{
...
//      print( stalkMat );
      ...
      stalkMat.SetBuffer("og_Points", _ogBuffer );
      stalkMat.SetMatrix("_World" , mainObject.transform.localToWorldMatrix );
            stalkMat.SetTexture("_AudioMap", audioTexture);
      stalkMat.SetTexture( "_NormalMap" , normalMap );
      stalkMat.SetTexture("_CubeMap" , cubeMap );   
...
//
      ...
      tipMat.SetBuffer("og_Points", _ogBuffer );
      tipMat.SetMatrix("_World" , mainObject.transform.localToWorldMatrix );
         tipMat.SetTexture("_AudioMap", audioTexture);
      tipMat.SetTexture( "_NormalMap" , normalMap );
      tipMat.SetTexture("_CubeMap" , cubeMap );   
      ...
      baseMat.SetMatrix("_World" , mainObject.transform.localToWorldMatrix );
           baseMat.SetTexture("_AudioMap", audioTexture);
      baseMat.SetTexture( "_NormalMap" , normalMap );
      baseMat.SetTexture("_CubeMap" , cubeMap );   
